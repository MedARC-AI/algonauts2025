...
def generate_config_variations():
    ...
    feature_combinations = [
        ...
        ['llama_3.2_3B/layers.11', 'whisper/layers.12', 'qwen-2-5-omni-3b/layers.20', 
         'internvl3_8b/layers.20', 'vjepa2/encoder.layernorm_avg'],

        # All features (new)
        ['llama_3.2_3B/layers.11', 'whisper/layers.12', 'qwen-2-5-omni-3b/layers.20', 'qwen-2-5-omni-7b/layers.20',
         'internvl3_8b/layers.20', 'vjepa2/encoder.layernorm_avg'],
    ]
...
def modify_config(base_config, params, features):
    ...
    config['out_dir'] = f"output_ensemble/feature_encoding_{param_suffix}_{feature_suffix}"
...
def generate_all_configs(base_config_path, output_dir, max_configs=None):
    ...
    if max_configs is None:
        ...
        sampled_combinations = random.sample(all_combinations, 
                                           min(max_configs // len(feature_combinations), 
...
def main():
    base_config_path = "/home/cesar/algo_sub/algonauts2025/config/default_feature_encoding.yaml"
