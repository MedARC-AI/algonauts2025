...
class AlgonautsDataset(Dataset):
    ...
    def _load_friends_features(self, movie: str, features: Dict):
        ...
        for episode_file in episode_files:
            ...
            with h5py.File(visual_path, 'r') as f:
                # features['visual'][episode_key] = f['mlp1.3'][:]
    ...
    def _load_movie10_features(self, movie: str, features: Dict):
        ...
        for partition in partitions:
            ...
            with h5py.File(visual_path, 'r') as f:
                # features['visual'][partition_base] = f['mlp1.3'][:]
...
if __name__ == '__main__':
    ...
    exp_name = f"40l_drop5_wd2av_sub{subject}_hrf{hrf_delay}_sw{stimulus_window}_{timestamp}"
